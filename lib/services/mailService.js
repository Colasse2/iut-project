...
module.exports = class MailService extends Service {
    ...
    async sendMoficationMovieNotificationEmail(email, movie) {
        const mailOptions = {
            from: process.env.MAIL_USER,
            to: email,
            subject: `Modification du film : ${movie.title}`,
            text: `Bonjour, le film intitulé "${movie.title}" a été modifié sur notre plateforme. Découvrez-le maintenant!\n\nRésumé: ${movie.description}\n\nL'équipe.`
        };
